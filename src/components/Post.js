...
const Post = (props) => {
    ...
    const [doseUserLiked, setDoseUserLike] = useState(props.post.likes.filter(like => like.username === props.user?.username).length !== 0);
        ...
        <div className="post">
            ...
            <div className="postData">
                ...
                <div className="likes">
                    ...
                    {props.user && (<button className='btn' onClick={() => likePost(props.post.id, doseUserLiked)}>{doseUserLiked ? 'Dislike' : 'Like'}</button>)}
            ...
            {deleteModalVisible && (<div className='delateConfirmation'>
